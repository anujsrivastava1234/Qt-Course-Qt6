...
0xc8,0x4,0x0,0x0,0x63,0x36,0x34,0x32,
...
0x0,0x0,0x0,0x0,0xf7,0xf2,0x76,0xb7,
0x56,0x7d,0x17,0xcf,0x4,0xe9,0xde,0xcd,
0x4a,0x4,0x90,0xc1,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0x36,0x0,0x30,0x0,0x62,0x0,0x30,0x0,
...
0x51,0x0,0x6d,0x0,0x6c,0x0,0x20,0x0,
...
aotContext->initGetEnumLookup(1, QMetaType::fromName("QWindow*").metaObject(), "Visibility", "FullScreen");
if (aotContext->engine->hasError())
    return 0.0;
}
{
...
int r2_1;
// generate_LoadQmlContextPropertyLookup
// while (!aotContext->loadSingletonLookup(2, &r2)) {
// aotContext->setInstructionPointer(2);
...
aotContext->setInstructionPointer(4);
aotContext->initGetEnumLookup(3, QMetaType::fromName("Qt").metaObject(), "WindowType", "Window");
if (aotContext->engine->hasError())
    return 0.0;
}
{
